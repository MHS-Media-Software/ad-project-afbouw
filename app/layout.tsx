...
export const metadata = {
  title: "ADAF Bouwgroep | Allround afbouwbedrijf in Wateringen",
  description: "ADAF Bouwgroep is uw betrouwbare allround aannemer voor nieuwbouw, verbouw, renovatie en transformatie in de regio Westland, Den Haag en Delft. Vraag vrijblijvend een offerte aan.",
};
